...
Vue.component("simple_header_component_1722932965", {
    template: `
        ...
        <nav id="nav-bar" class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a id="logo-link" href="#" class="flex items-center">
                    ...
                    <span id="app-name" class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">EthScan: Real-Time Ethereum Transaction Tracker</span>
                </a>
                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    ...
                    <button id="hello-world-button" class="ml-4 px-4 py-2 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600">Hello World</button>
                    <button id="submit-button" class="ml-4 px-4 py-2 bg-green-500 text-white rounded-lg shadow-md hover:bg-green-600">Submit</button>
                </div>
            </div>
        </nav>
    </header>`,
