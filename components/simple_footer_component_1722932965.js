...
*/
Vue.component("simple_footer_component_1722932965", {
    template: `
    <div>
        <nav class="bg-white shadow-md dark:bg-gray-800">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="#" class="flex items-center">
                    <img src="./images/logo.svg" class="h-8 mr-3" alt="EthScan Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">EthScan</span>
                </a>
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            EthScan: Real-Time Ethereum Transaction Tracker
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        © 2023 EthScan. Empowering Ethereum users with instant transaction insights.
                    </div>
                </div>
            </div>
        </footer> 
